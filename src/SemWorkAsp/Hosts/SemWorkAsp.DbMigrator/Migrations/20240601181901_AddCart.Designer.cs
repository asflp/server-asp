...
namespace SemWorkAsp.DbMigrator.Migrations
{
    ...
    [Migration("20240601181901_AddCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvertisementUser", b =>
                {
                    ...
                    b.Property<Guid>("InCartId")
                        .HasColumnType("uuid");

                    b.HasKey("CartId", "InCartId");
            ...
            modelBuilder.Entity("SemWorkAsp.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 6, 1, 21, 19, 0, 824, DateTimeKind.Local).AddTicks(257));
            ...
            modelBuilder.Entity("AdvertisementUser", b =>
                {
                    b.HasOne("SemWorkAsp.Domain.Entities.Advertisement", null)
                        .WithMany()
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SemWorkAsp.Domain.Entities.User", null)
                        .WithMany()
